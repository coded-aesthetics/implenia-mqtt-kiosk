...
export function Header({ connectivity, hasApiKey, currentPage, pageTitle, voiceSupported, isListening, onMicPress, onMicRelease }: Props) {
      ...
      <div style={styles.rightSection}>
        ...
        {voiceSupported && (
          <button
            ...
            aria-label={isListening ? 'Spracherkennung aktiv' : 'Sprachbefehl'}
          >
