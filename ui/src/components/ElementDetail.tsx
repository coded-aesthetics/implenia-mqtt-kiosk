...
export function ElementDetail({ elementName, readings, vorgaben, vorgabenLoading }: Props) {
        ...
        <div style={styles.tilesColumn}>
          ...
          {activeTab === 'vorgabe' && (
            <div style={styles.viewContent}>
              ...
              {!vorgabenLoading && vorgabeEntries.length === 0 && coordinates.length === 0 && !geologyProfile && (
